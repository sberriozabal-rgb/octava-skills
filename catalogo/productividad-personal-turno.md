...
`productividad-personal-turno` · v1.1.1 · Hostelería

> Sabes en qué franjas pagas plantilla sin venta y en cuáles pierdes venta por falta de mano.

**Precio:** 199 € suelta · o en la Instalación Completa
...
**Pago único, descarga inmediata:** <https://cabina.gumroad.com/l/productividad-personal-turno>. Si el enlace aún no responde, la tienda está en alta: abre un *issue* en este repositorio con el nombre del producto.
